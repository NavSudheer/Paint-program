...
public class PaintSaveFileParserTest {
	...
	public void parserTest17() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_fail.txt",
				"Returns false for rgb incorect", "Error in line 3 ");
	}
	@Test
	...
	public void parserTest19() throws IOException {
		this.doParserTestCase("samplefiles/circle_no_end.txt",
				"Returns false for multiple shapes file with incorrect end shape", "False");
	}
	@Test
	public void parserTest20() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_multiple.txt",
				"Returns true for multiple squiggles", "");
	}
	@Test
	public void parserTest21() throws IOException {
		this.doParserTestCase("samplefiles/circle_with_space.txt",
				"Returns true for circle with a multiple spaces", "");
	}
	@Test
	public void parserTest22() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_wrongend.txt",
				"Returns false for missing the end after creating rectangles ", "false");
	}
	@Test
	public void parserTest23() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_wrongcolors.txt",
				"Returns false for missing the end after creating a rectangle ", "Error in line 3 ");
	}
	@Test
	public void parserTest24() throws IOException {
		this.doParserTestCase("samplefiles/rectangle_fail_filled.txt",
				"Returns false, filled is incorrect for rectangle", "Error in line 4 ");
	}
	@Test
	public void parserTest25() throws IOException {
		this.doParserTestCase("samplefiles/squiggle_fail_filled.txt",
				"Returns false, filled is incorrect for squiggle", "Error in line 4 ");
	}
	@Test
	public void parserTest26() throws IOException {
		this.doParserTestCase("samplefiles/extra_end_fail.txt",
				"Returns false, there is an extra end", "Error in line 3 ");
	}
	@Test
	public void parserTest27() throws IOException {
		this.doParserTestCase("samplefiles/negative_rectangles.txt",
